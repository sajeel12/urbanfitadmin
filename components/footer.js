                ...
                <section className="pt-10 md:p-20 lg:py-28 md:pb-7">
                    <div className="w-full h-2/6 pb-7 px-6 md:pb-16 lg:px-[5%] border-b border-b-gray-400 flex flex-row flex-wrap justify-between items-start">
                        <div className="w-full lg:w-1/2 flex justify-around items-start">
                            <span className='w-1/2 md:w-48pr mx-auto lg:mx-0 mb-7 flex flex-col justify-center text-center' >
                                ...
                                <h5 className="my-3 text-10px md:text-sm font_gotham_medium tracking-widest lg:tracking-expand">100% SECURE PAYMENT</h5>
                                <p className="w-4/5 mx-auto text-10px lg:text-xs">Moving your card details to a much more secured place</p>
                            </span>
                            <span className='w-1/2 md:w-48pr mx-auto lg:mx-0 mb-7 flex flex-col justify-center text-center' >
                                <i className="fa-solid fa-wallet text-black mb-5 text-xl"></i>
                                <h5 className="my-3 text-10px md:text-sm font_gotham_medium tracking-widest lg:tracking-expand">TRUST PAY</h5>
                        ...
                        <div className="w-full lg:w-1/2 flex justify-around items-start">
                            <span className='w-1/2 md:w-48pr mx-auto lg:mx-0 mb-7 flex flex-col justify-center items-center text-center' >
                                ...
                                <h5 className="my-3 text-10px md:text-sm font_gotham_medium tracking-widest lg:tracking-expand">HELP CENTER</h5>
                            ...
                            <span className='w-1/2 md:w-48pr mx-auto lg:mx-0 mb-7 flex flex-col justify-center items-center text-center' >
                                ...
                                <h5 className="my-3 text-10px md:text-sm font_gotham_medium tracking-widest lg:tracking-expand">EXPRESS SHIPPING</h5>
                                <p className="w-4/5 mx-auto text-10px lg:text-xs">Moving your card details to a much more secured place</p>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="w-full mt-10 px-6 lg:px-0 flex flex-col lg:flex-row justify-between items-start md:items-start">
                        ...
                        <div className="list-none pb-7 md:pb-3 space-y-4 flex flex-col items-start">
                            ...
                            <li>
                                <Link href='/trackorder'>Collections</Link>
                            </li>
                            <li>
                        ...
                        <div className="hidden lg:flex w-full md:w-1/5 flex-col justify-start items-start md:items-end gap-y-5">
                            ...
                            <p className='font_gotham text-xs'>SUPPORT@URBANFITS.AE</p>
                            <div className="mt-6 flex flex-col items-end">
                                <h3 className="text-xs font_gotham_medium tracking-[0.3em]">PAYMENT METHODS</h3>
