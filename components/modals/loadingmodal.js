...
export default function LoadingModal(props) {
    ...
    return (
        <>
            ...
            <div className={`w-full h-full font_gotham fixed inset-0 z-30 bg-gray-800/40 backdrop-blur flex justify-center items-center transition-all duration-500 ${props.show === false ? "opacity-0 pointer-events-none" : ''}`}>
